...
import productImage from "../assets/images/benifits/image1.png"; // Replace with actual image path
import { IoShieldCheckmark } from "react-icons/io5";

const BenefitsSection = () => {
  return (
    <div className=" hidden md:flex flex-col justify-center items-center h-screen bg-yellow-50 space-y-5">
...
{/* Text Labels Positioned at Exact Diagonal Points */}
...
<div className="absolute flex flex-col top-[18%] left-[-2%] text-end font-bold text-green-900 leading-tight neue-haas-bold">
  <span>Immune</span> <span>Boost</span>
        ...
        {/* Small Circular Points at Each Diagonal Position */}
      ...
      {/* Button & Guarantee Section (Reduced Space) */}
